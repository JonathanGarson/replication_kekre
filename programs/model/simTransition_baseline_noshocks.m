%% simTransition_baseline_noshocks.m
% Simulates transitional dynamics starting from baseline RCE 
%  without any shocks to net out computational error from dynamics with shocks

masterTime = tic;

RCEName = 'output/RCE_baseline';
transName = 'output/trans_baseline_noshocks';

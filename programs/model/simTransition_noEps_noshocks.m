%% simTransition_noEps_noshocks.m
% Simulates transitional dynamics starting from identical separation rate RCE
%  without any shocks to net out computational error from dynamics with shocks

masterTime = tic;

RCEName = 'output/RCE_noEps';
transName = 'output/trans_noEps_noshocks';

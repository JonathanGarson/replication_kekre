%% simGR_expiration.m
% Runs GR.m assuming January 2013 UI extensions were expected to last for 
%  24 months but then unexpectedly expired in December 2013
...
Hss_start56 = Hss1(:,selectCols==1);
Hss_start56 = Hss_start56(selectRows==1,:);
dH_start56 = dH(:,selectCols==1);
dH_start56 = dH_start56(selectRows==1,:);     

% Generate duration of UI in Great Recession assuming last extension 
%  would last for 24 months
[~,dbarPathMonths,dbarShockMonths] = genUIGreatRecession_expiration(Tbar,24);

try
    GR(Tbar,80,0,nan,0.95,...
        zeros(1,80),0,dbarPathMonths,dbarShockMonths,Hss_start56,dH_start56,urdata,0,...
        transParamsSticky,...
        RCEName,'output/GR_iota0p94_expiration',invariantParams,varyingParams,...
        ...
        56,'output/GR_iota0p94_ui_time56',[]);             
catch err

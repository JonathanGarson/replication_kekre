function [dbarPathWeeks,dbarPathMonths,dbarShockMonths] = genUIGreatRecession(Tbar)
%% genUIGreatRecession.m
% Returns path of UI used in Great Recession simulation 
...
dbarPathWeeks(1:12,57) = 26+37; % to match ui_weeks_fv
for time=58:80
	dbarPathWeeks(1:(end-1),time) = dbarPathWeeks(2:end,time-1);
end

%% simGR_time1.m
% Calibrates one period of discount factor shock to match unemployment 
%  in 05/2008 and construct Jacobian.  Assumes iota = 0.975 for concreteness.
...
try
    GR(Tbar,1,1,8*5.2500e-05,0.95,...
        zeros(1,80),0,dbarPathMonths,dbarShockMonths,Hss,[],urdata,0,...
        transParamsSticky,...
        RCEName,'output/GR_time1',invariantParams,varyingParams,...

...
#SBATCH --cpus-per-task=5          # number of CPUs requested (for parallel tasks)
...
#SBATCH --job-name=simTransition_baseline_macro   # user-defined job name
...
srun matlab -nodisplay < simTransition_baseline_macro.m
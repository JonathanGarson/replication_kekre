%% simTransition_liquid.m
% Simulates UI shocks under liquid wealth calibration given nominal 
...
load(strcat('output/trans_liquid_noshocks_sticky.mat'),'znextTrans','zsupplyTrans',...
...
load('output/RCE_liquid');
load('output/jacobian_liquid_1.mat');
H1 = H;
clearvars H;
Tbar = 481;
...
try
    [~,~,~,~,~,~,~,...
        ...
        RCEName,'output/trans_liquid_fixedi',invariantParams,varyingParams,...

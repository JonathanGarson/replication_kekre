%% simTransition_baseline_dur.m
% Simulates UI shocks under alternative assumptions on horizon of extension,
...
HssCell = cell(1,11);
varyingParamsCell = cell(1,11);
transParamsCell = cell(1,11);
suffixCell = cell(1,11);
...
for i=1:11    
    ...
    thisDur = i*3;
    thisVaryingParams.dbar(1:thisDur) = thisVaryingParams.dbar(1:thisDur)+3; 
    ...
    suffixCell{i} = ['dur_',num2str(thisDur),'_fixedi'];
end

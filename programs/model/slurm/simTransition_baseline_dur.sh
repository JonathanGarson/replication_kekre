...
#SBATCH --cpus-per-task=11          # number of CPUs requested (for parallel tasks)
...
#SBATCH --job-name=simTransition_baseline_dur   # user-defined job name
...
srun matlab -nodisplay < simTransition_baseline_dur.m
%% simGR_seprate_ui.m
% Given separation rate shocks, calibrates discount factor shocks to match 
%  unemployment dynamics from 05/2008-12/2014 under real wage rigidity = 0.94

masterTime = tic;
startBetaShock = 8*5.2500e-05 + (0.94-0.975)*8*((5.2244e-05)-(5.2755e-05))/.01;
...
try
    GR(Tbar,80,0,startBetaShock,0.95,...
        deltaBarShocks,deltaBarPersist,dbarPathMonths,dbarShockMonths,Hss,dH,urdata,0,...
        transParamsSticky,...
        RCEName,'output/GR_seprate_iota0p94_ui',invariantParams,varyingParams,...

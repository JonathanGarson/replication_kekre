%% simTransition_baseline_dbarbar22_noshocks.m
% Simulates transitional dynamics starting from baseline RCE (dbarbar = 22)
%  without any shocks to net out computational error from dynamics with shocks

masterTime = tic;

RCEName = 'output/RCE_baseline_dbarbar22';
transName = 'output/trans_baseline_dbarbar22_noshocks';

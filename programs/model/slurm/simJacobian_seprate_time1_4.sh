...
#SBATCH --cpus-per-task=27          # number of CPUs requested (for parallel tasks)
#SBATCH --mem-per-cpu=10G           # requested memory
#SBATCH --time=0-08:00:00          # wall clock limit (d-hh:mm:ss)

#---------------------------------------------------------------------------------
# Job specific name (helps organize and track progress of jobs)

#SBATCH --job-name=simJacobian_seprate_time1_4   # user-defined job name
...
srun matlab -nodisplay < simJacobian_seprate_time1_4.m
...
%  dynamics
load(strcat('output/GR_time1.mat'),'znextTrans','zsupplyTrans',...
    'cTrans','prodTrans','tTrans','this_t','mTrans','this_m',...
    'vacpostTrans','sfNewHiresTrans','wTrans','this_w',...
    'betasTrans','dist2','this_theta','this_mu','MTrans');
...
save(['output/jacobian_time1_',num2str(varGroup)],'H');

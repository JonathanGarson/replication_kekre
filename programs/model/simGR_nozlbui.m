%% simGR_nozlbui.m
% Runs baseline calibration with discount factor shocks calibrated in
%  simGR_ui without ZLB and UI
...
shocksStruct = load('output/GR_iota0p94_ui','shocks');
betaShocks = shocksStruct.shocks;

transParamsSticky = ...
    struct('psi',360,'adjResource',0,'epsilon',6,'phiInt',1/m-1,'phiPi',1.5,'phiC',1/12,'phiRho',0,'zlb',0,'fixedM',0,'fixedm',0,...
...
try
    GR(Tbar,80,0,betaShocks(1),0.95,...
        zeros(1,80),0,dbarPathMonths,dbarShockMonths,Hss,dH,urdata,0,...
        transParamsSticky,...
        RCEName,'output/GR_iota0p94_nozlbui',invariantParams,varyingParams,...

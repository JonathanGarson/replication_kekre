%% ident_eps_delta_beta.m
% Characterizes identification of eps_delta_a
...
varyParam1 = 'eps_delta_beta'; 
varyRange1 = [-3.95 -4.15 -4.35 -4.55 -4.75];
varyParam2 = nan; % set to nan if only one parameter needs to change
varyRange2 = nan(1,5);

...
#SBATCH --cpus-per-task=24          # number of CPUs requested (for parallel tasks)
...
#SBATCH --job-name=simJacobian_seprate_time1_1   # user-defined job name
...
srun matlab -nodisplay < simJacobian_seprate_time1_1.m
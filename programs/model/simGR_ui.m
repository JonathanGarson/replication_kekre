%% simGR_ui.m
% Calibrates discount factor shocks to match unemployment dynamics from 
%  05/2008-12/2014 under alternative values of real wage rigidity
...
startBetaShock = 8*5.2500e-05 + (iotaVals-0.975)*8*((5.2244e-05)-(5.2755e-05))/.01;
...
parfor iotaInd=1:length(iotaVals)
    ...
    try
        GR(Tbar,80,0,startBetaShock(iotaInd),0.95,...
            zeros(1,80),0,dbarPathMonths,dbarShockMonths,Hss,dH,urdata,iotaInd,...
            transParamsSticky,...
            RCEName,['output/GR_',suffixCell{iotaInd},'_ui'],invariantParams,varyingParams,...
        ...
        disp(['Error on worker ',num2str(iotaInd),': ',err.identifier]);
    end
end

%% simGR_seprate_noui.m
% Runs calibration with discount factor shocks calibrated in
%  simGR_seprate_ui without UI shocks
...
load('output/jacobian_seprate_time1_1.mat');
H1_time1 = H;
clearvars H;
load('output/jacobian_seprate_time1_2.mat');
H2_time1 = H;
clearvars H;
load('output/jacobian_seprate_time1_3.mat');
H3_time1 = H;
clearvars H;
load('output/jacobian_seprate_time1_4.mat');
H4_time1 = H;
clearvars H;
load('output/GR_seprate_time1.mat');
p_ePath1 = p_ePath(1);
...
shocksStruct = load('output/GR_seprate_iota0p94_ui.mat','shocks');
...
% Maintain counterfactually constant UI
dbarPathMonths = dbar*ones(Tbar,80);
dbarShockMonths = zeros(1,80);

try
    GR(Tbar,80,0,betaShocks(1),0.95,...
        deltaBarShocks,deltaBarPersist,dbarPathMonths,dbarShockMonths,Hss,dH,urdata,0,...
        transParamsSticky,...
        RCEName,'output/GR_seprate_iota0p94_noui',invariantParams,varyingParams,...

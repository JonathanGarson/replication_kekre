%% simTransition_durElast_noshocks.m
% Simulates transitional dynamics starting from high duration elasticity RCE 
%  without any shocks to net out computational error from dynamics with shocks

masterTime = tic;

RCEName = 'output/RCE_durElast';
transName = 'output/trans_durElast_noshocks';
...
epsSticky = [0.1 0.00005 0.00005 0.00012 0.00005 0.00005];
transParamsSticky = ...

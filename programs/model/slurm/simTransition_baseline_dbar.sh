...
#SBATCH --cpus-per-task=12          # number of CPUs requested (for parallel tasks)
...
#SBATCH --job-name=simTransition_baseline_dbar   # user-defined job name
...
srun matlab -nodisplay < simTransition_baseline_dbar.m
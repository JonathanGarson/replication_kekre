function [dbarPathWeeks,dbarPathMonths,dbarShockMonths] = genUIGreatRecession_noexpiration(Tbar,lastHoriz)
%% genUIGreatRecession_noexpiration.m
% Returns path of UI to be used in Great Recession simulation, assuming
%  that benefit extension in 1/2013 lasted for lastHoriz periods 
...
% May 2009 (calendar month 13) -- assume EB introduced here
